...
const Testimonial = () => {
    ...
    const testimonials = [
        {
          id: 1,
          name: "Fawaz Ismail Yousef Al-Yousef",
          rating: 5,
          text: "Director – Landscaping: King Salman International Airport Development Company "
        },
        // {
        //   id: 2,
        //   name: "DACO",
    ...
    return (
        <div className='py-10 bg-gray-100 relative' id='testimonial'>
                <h1 className='text-center text-2xl lg:text-4xl font-bold'> Other Services </h1>
                        ...
                        testimonials.map((item)=> {
                            ...
                            <div className='border border-gray-400 shadow-md shadow-red-500 rounded-lg flex flex-col p-4'>
                                ...
                                <div className='flex justify-between items-center'>
                                  ...
                                  <p className='text-sm mt-1'>Director – Landscaping:</p>
                                  </div>
